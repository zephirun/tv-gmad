...
export default function Player({ currentItem, playlist, currentIndex, next, isMuted }) {
            ...
            {currentItem.type === 'video' && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Play style={{ width: '16px', height: '16px', color: '#f97316', fill: '#f97316' }} />
                        <span style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '0.875rem', fontWeight: 500 }}>Reproduzindo vídeo</span>
                    </div>
                </div>
            )}
