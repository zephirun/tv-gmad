...
export default function App() {
  ...
  return (
    <div style={appContainerStyle}>
      {/* Admin Panel */}
      {isAdminOpen && <AdminPanel collectionId={collectionId} playlist={playlist} setPlaylist={setPlaylist} news={newsItems} setNews={setNewsItems} user={user} onClose={() => setIsAdminOpen(false)} />}
