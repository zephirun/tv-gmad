            ...
            <div style={contentStyle}>
                ...
                <div style={instagramCardStyle}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <img
                            src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(currentInsta.url)}&color=166534`}
                            alt="Instagram QR"
                            style={{ width: '70px', height: '70px', borderRadius: '8px', flexShrink: 0, transition: 'all 0.5s ease', marginRight: '10px', backgroundColor: '#f3f4f6' }}
                            onError={(e) => { e.target.style.display = 'none'; }}
                        />
